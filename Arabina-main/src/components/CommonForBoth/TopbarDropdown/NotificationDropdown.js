            ...
            <SimpleBar style={{ height: "230px" }}>
              <Link to="" className="text-reset notification-item">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h6 className="mt-0 mb-1">Saleh Shihab</h6>
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">check the latest file on crm project</p>
              ...
              <Link to="" className="text-reset notification-item">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h6 className="mt-0 mb-1">Mohammad Nassar</h6>
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">{this.props.t('ODM ticket to solve') + "."}</p>
              ...
              <Link to="" className="text-reset notification-item">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h6 className="mt-0 mb-1">Ahmad Ali</h6>
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">your medical report is ready</p>
                      <p className="mb-0"><i className="mdi mdi-clock-outline"></i> {this.props.t('3 min ago')}</p>
                    </div>
                  </div>
                </div>
              ...
              <Link to="" className="text-reset notification-item">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h6 className="mt-0 mb-1">salma omar</h6>
                    <div className="font-size-12 text-muted">
                      <p className="mb-1">request for new meeting on 2:00 pm</p>
                      <p className="mb-0"><i className="mdi mdi-clock-outline"></i>{this.props.t('1 hours ago')} </p>
                    </div>
                  </div>
                </div>
